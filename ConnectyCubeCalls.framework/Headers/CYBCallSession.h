...
/**
 CYBCallSession class interface.
...
/**
 ...
 @note Available only for 1 to 1 audio and video calls, nil otherwise. Not available for low performance devices, such as iPod1,1, iPod2,1, iPod3,1, iPod4,1, iPod5,1, iPhone1,1, iPhone1,2, iPhone2,1, iPhone3,1, iPhone4,1, iPad1,1, iPad2,1, iPad2,2, iPad2,3, iPad2,4, iPad2,5, iPad2,6, iPad2,7. Will become nil if record was finished and finalized AND session was closed.

 @see UIDevice+CYBCallPerformance, CYBCall_isLowPerformance
 */
@property (strong, nonatomic, nullable) CYBCallRecorder *recorder;
...
/**
 Start call. Opponent will receive new session signal in CYBCallClientDelegate method 'didReceiveNewSession:userInfo: called by startCall: or acceptCall:
...
/**
 Accept call. Opponent's will receive accept signal in CYBCallClientDelegate method 'session:acceptedByUser:userInfo:'
...
/**
 Reject call. Opponent's will receive reject signal in CYBCallClientDelegate method 'session:rejectedByUser:userInfo:'
...
/**
 Hang up. Opponent's will receive hung up signal in CYBCallClientDelegate method 'session:hungUpByUser:userInfo:'
