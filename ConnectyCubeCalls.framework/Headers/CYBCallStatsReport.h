 ...
 */
@property (nonatomic, strong, readonly) CYBCallBitrateTracker *audioReceivedBitrateTracker;

/**
 Audio send bitrate tracker
 */
@property (nonatomic, strong, readonly) CYBCallBitrateTracker *audioSendBitrateTracker;

/**
 Connection received bitrate tracker
 */
@property (nonatomic, strong, readonly) CYBCallBitrateTracker *connectionReceivedBitrateTracker;

/**
 Connection send bitrate tracker
 */
@property (nonatomic, strong, readonly) CYBCallBitrateTracker *connectionSendBitrateTracker;

/**
 Video received bitrate tracker
 */
@property (nonatomic, strong, readonly) CYBCallBitrateTracker *videoReceivedBitrateTracker;

/**
 Video send bitrate tracker
 */
@property (nonatomic, strong, readonly) CYBCallBitrateTracker *videoSendBitrateTracker;
