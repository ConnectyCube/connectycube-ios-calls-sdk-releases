...
CYBCALL_EXPORT
@interface UIDevice (CYBCallPerformance)
 ...
 */
@property (nonatomic, readonly, getter=CYBCall_isLowPerformance) BOOL CYBCall_lowPerformance;
...
/**
 ...
 @remark Medium performance device list:
            ...
            iPhone5,1, iPhone5,2
 */
@property (nonatomic, readonly, getter=CYBCall_isMediumPerformance) BOOL CYBCall_mediumPerformance;
